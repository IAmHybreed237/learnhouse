...
const CATEGORIES = [
  { label: 'Programming', count: 'Courses' },
  { label: 'Data Analytics', count: 'Courses' },
  { label: 'Design and UX', count: 'Courses' },
  { label: 'Business and Management', count: 'Courses' },
  { label: 'Digital Marketing', count: 'Courses' },
  { label: 'Finance and Investing', count: 'Courses' },
  { label: 'AI and Machine Learning', count: 'Courses' },
  { label: 'E-commerce', count: 'Courses' },
  { label: 'Health and Wellbeing', count: 'Courses' },
  { label: 'Personal Development', count: 'Courses' },
]
